<?php 
    ...
    $date = '10-12 December';
    $loc = 'Downtown Conference Center, New York';
    $speakers = array("Brenden Legros","Hubert Hirthe","Cole Emmerich","Jack Christiansen","Alejandrin Littel","Willow Trantow");
    $array1 = array("Quas alias incidunt","Consequuntur odio aut","Fugiat laborum et","Debitis iure vero","Qui molestiae natus","Non autem dicta");
    $array2 = array("Home"=>"#intro", "About"=>"#about", "Speakers"=>"#speakers", "Schedule"=>"#schedule", "Venue"=>"#venue", "Hotels"=>"#hotels", "Gallery"=>"#gallery", "Sponsors"=>"#supporters", "Contact"=>"#contact", "Buy Tickets"=>"#buy-tickets");
...
<?php 
          for($i=0;$i<10;$i++){
            ...
            if($i == 0) {
               echo('<li class="menu-active"><a href="'.$array2[$array3[$i]].'">'.$array3[$i].'</a></li>');
               }

            if($i == 9) {
               echo('<li class="buy-tickets"><a href="'.$array2[$array3[$i]].'">'.$array3[$i].'</a></li>');
              }

           if($i>0 && $i<9) {
             echo('<li><a href="'.$array2[$array3[$i]].'">'.$array3[$i].'</a></li>');
            }
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0"><?php echo($title)  ?></h1>
      <p class="mb-4 pb-0"><?php echo("$date, $loc") ?></p>
